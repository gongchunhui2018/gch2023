...
export default function IconDesign(){
    const colors = ['#84cc16','#3b82f6','#f97316','#22c55e']
    const size = ['64','48','24','86']
    const type = ['填充','描边']
    ...
    return(
        <div className="w-[67.5rem] h-auto flex flex-row gap-4 ">
              <div className="GCHcard w-3/4 p-5 h-auto">
                  <IconGroup
              ...
              <div className="GCHcard w-1/4 h-auto flex flex-col gap-7 p-5">
                  <div className=" flex flex-col">
                     <p className="GCHtitle-base">图标自定义</p>
                     <p className="GCHtext-xs">自定义图标样式</p>
                  </div>

                  {/* 类型自定义 */}
                  <div className="w-full flex flex-col gap-3">
                      <p className="GCHtitle-xs">类型</p>
                  ...
                  {/* 尺寸自定义 */}
                  <div className="w-full flex flex-col gap-3">
                      <p className="GCHtitle-xs">尺寸（px）</p>
...
const IconGroup = (props) => {
    ...
    const icons = [
        <IconA type={setType} size={setSize} color={setColor}/>,
        <IconB type={setType} size={setSize} color={setColor}/>,
        <IconC type={setType} size={setSize} color={setColor}/>,
        <IconD type={setType} size={setSize} color={setColor}/>,
        <IconE type={setType} size={setSize} color={setColor}/>,
        <IconF type={setType} size={setSize} color={setColor}/>,
        <IconG type={setType} size={setSize} color={setColor}/>,
        <IconH type={setType} size={setSize} color={setColor}/>
    ...
    return(
        <div className="w-full h-full grid grid-cols-4 gap-3">
            {icons.map((item,index) => {
                return(
                    <div className="flex justify-center items-center rounded-lg border border-[#2e2e2e]">
                        {item}
                    </div>
                )
            })}
